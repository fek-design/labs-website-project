...
The system SHALL provide a horizontally scrollable carousel displaying prototype product categories for student inspiration.
...
The system SHALL present showcase cards containing interactive hotspot beacons that reveal specific equipment or process details upon user interaction.

#### Scenario: Triggering an equipment hotspot
- **WHEN** the visitor hovers or clicks on a pulsing hotspot beacon over a project showcase card
- **THEN** an informative tooltip tag (e.g., `Print på T-Shirt ↳`) is revealed with smooth enter motion.
